...
class DataAugmentor:
    ...
    def _detect_device(seed_value):
        """
        Function to detect the device for training.
        :param seed_value: Use to set seed value for all random generators.
        """
    ...
    def create_dataframe(cls, train_path):
        """
        Function to create dataframe containing required columns for training.
        """
        df = pd.read_csv(
